...
public class AlterarProduto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtQtdeAtual.setNextFocusableComponent(btnAlterar);
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(108, 108, 108)
                                        .addComponent(btnAlterar, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        prodBEAN.setIdProduto(ID);
        
        prodBEAN.setDescricao(txtDescricao.getText());
        prodBEAN.setPreco(Double.parseDouble(txtPreco.getText()));
        prodBEAN.setUnidade(txtUnidade.getText());
        prodBEAN.setQtde_inicial(Double.parseDouble(txtQtdeInicial.getText()));
        prodBEAN.setQtde_atual(Double.parseDouble(txtQtdeAtual.getText()));
        prodBEAN.setData_cad(txtData.getText());

        prodBEAN = cont.alterar(prodBEAN);
    ...
    private void tblDadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDadosMouseClicked
        ...
        txtDescricao.setText((String) tblDados.getValueAt(linha, 1));
        txtPreco.setText(String.valueOf(tblDados.getValueAt(linha, 2)));
        txtUnidade.setText((String) tblDados.getValueAt(linha, 3));
        txtQtdeInicial.setText(String.valueOf(tblDados.getValueAt(linha, 4)));
        txtQtdeAtual.setText(String.valueOf(tblDados.getValueAt(linha, 5)));
        //txtData preenche automatico no visuDataHora(), sempre com o dia atual
